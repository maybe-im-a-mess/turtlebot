...
$(info $(PARENT_CLASS))
# first strip parent class name, then underscore. Otherwise stripping
# does not for model names without any serialized arguments. For example
# 'wall' has no serialized arguments
...
# mako-render script does not work with relative dirs
# which are outside of the directory where mako-render runs.
# Use absolute path as a workaround using $(abspath ...)
